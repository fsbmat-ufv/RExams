...
* A propriedade $\sum_{i=1}^{n} (a_i + b_i) = \sum_{i=1}^{n} a_i + \sum_{i=1}^{n} b_i$ é verdadeira. {6:MC:=Verdadeiro~Falso}

* A propriedade $\sum_{i=1}^{n} c a_i = c \sum_{i=1}^{n} a_i$ é válida para qualquer constante real $c$. {7:MC:=Verdadeiro~Falso}

* A identidade $\sum_{i=1}^{n} a_i - b_i = \sum_{i=1}^{n} a_i - \sum_{i=1}^{n} b_i$ é válida. {8:MC:=Verdadeiro~Falso}

* A propriedade $\sum_{i=1}^{n} a_i b_i = \sum_{i=1}^{n} a_i \cdot \sum_{i=1}^{n} b_i$ é válida. {9:MC:=Falso~Verdadeiro}
