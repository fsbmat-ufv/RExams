...
mais_homogenea <- as.numeric(ifelse(CV_A1 < CV_A2, 1, 2))
...
Qual das duas amostras é a mais homogênea, isto é, a de menor dispersão relativa? Justifique sua resposta calculando todas as medidas utilizadas.
...
exsolution: `r sprintf('%.2f|%.2f|%.0f', as.numeric(CV_A1), as.numeric(CV_A2), as.numeric(mais_homogenea))`  
extol: 0.02|0.02|0
